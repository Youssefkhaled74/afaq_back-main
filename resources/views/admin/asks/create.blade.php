                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Ask Form</h4>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{url(route('admin/asks/create'))}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-floating">
                                                <input name="ask" type="text" class="form-control" id="askfloatingInput" placeholder="ask">
...
<script>
    (function () {
        ...
        // $('#sidebarasks').addClass('show').siblings().removeClass('collapsed').attr('aria-expanded', 'true');
