                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="direction: ltr;">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('admin/comments/index')}}/0/{{PAGINATION_COUNT}}">Comments</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Comments Viwes</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="dataTables_scroll">
                                            <div class="dataTables_scrollBody" style="position: relative; overflow: auto; width: 100%">
                                                ...
                                                <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                                    Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Comment::archive()->count()}}</span> entries
                                                </div>
                                                            ...
                                                            <nav aria-label="Page navigation">
                                                                <ul class="pagination flex-wrap justify-content-center" style="align-items: center;">
                                                                    ...
                                                                    @for ($i = 1; $i <= $comments->lastPage(); $i++)
                                                                        <li class="page-item mt-1 {{ $i == $comments->currentPage() ? 'active' : '' }}">
                                                                            <a class="page-link" href="{{ $comments->url($i) }}"
                                                                            @if ($i == $comments->currentPage()) style="font-weight:bold;" @endif>
                                                                                {{ $i }}
                                                                            </a>
                                                                        </li>
                                                                    @endfor
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/comments/back'))}}" method="get">
...
@section('script')
    <script>
        (function () {
            ...
            $('.sidebarcomments').addClass('active');
            var target = $('.sidebarcomments').attr('href');
    ...
    <script>
        ...
        $(document).on('click', '#load_more_button', function() {
            var urlPath = `{{ route("admin/comments/pagination/archives")}}/${offset}/${limit}`;
        ...
        $(document).on('keyup', '.data_search', function() {
            var q = $(this).val();
            var urlPath = "{{ route('admin/comments/search/archives') }}";
            event.preventDefault();
