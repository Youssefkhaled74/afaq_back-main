                                                        ...
                                                        @isset($comments)
                                                            @foreach($comments as $record)
                                                                ...
                                                                <tr class="text-center">
                                                                    ...
                                                                    <td class="text-center">{{$record->article?->title ?? 'article'}}</td>
                                                                    <td class="text-center">{{$record->user?->name ?? 'visitor'}}</td>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/comments/delete'))}}" method="get">
                                                ...
                                                <div class="modal fade" id="myModalActivation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/comments/activate'))}}" method="get">
