                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Comment Form</h4>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{url(route('admin/comments/create'))}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="Comment_id" id="comments">
...
<script>
    (function () {
        ...
        // $('#sidebarcomments').addClass('show').siblings().removeClass('collapsed').attr('aria-expanded', 'true');
