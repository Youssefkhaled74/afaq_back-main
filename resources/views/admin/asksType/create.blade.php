                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">AsksType Form</h4>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{url(route('admin/asksType/create'))}}" method="post" enctype="multipart/form-data">
...
<script>
    (function () {
        ...
        // $('#sidebarasksType').addClass('show').siblings().removeClass('collapsed').attr('aria-expanded', 'true');
