                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent" style="direction: ltr;">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('admin/asksType/index')}}/0/{{PAGINATION_COUNT}}">AsksType</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">AsksType Viwes</h5>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="dataTables_scroll">
                                            <div class="dataTables_scrollBody" style="position: relative; overflow: auto; width: 100%">
                                                ...
                                                <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                                    Showing 1 to <span id="showItems"></span> of <span>{{App\Models\AsksType::archive()->count()}}</span> entries
                                                </div>
                                                        ...
                                                        <div class="d-flex justify-content-center mt-2">
                                                            <nav aria-label="Page navigation">
                                                                <ul class="pagination flex-wrap justify-content-center" style="align-items: center;">
                                                                    <!-- Previous Button -->
                                                                    @if (!$asksType->onFirstPage())
                                                                        <li class="page-item mt-1">
                                                                            <a class="page-link" href="{{ $asksType->previousPageUrl() }}"
                                                                            aria-label="Previous">
                                                                    ...
                                                                    <!-- Pagination Numbers -->
                                                                    @for ($i = 1; $i <= $asksType->lastPage(); $i++)
                                                                        <li class="page-item mt-1 {{ $i == $asksType->currentPage() ? 'active' : '' }}">
                                                                            <a class="page-link" href="{{ $asksType->url($i) }}"
                                                                            @if ($i == $asksType->currentPage()) style="font-weight:bold;" @endif>
                                                                                {{ $i }}
                                                                            </a>
                                                                        </li>
                                                                    @endfor
                                                                    ...
                                                                    <!-- Next Button -->
                                                                    @if ($asksType->hasMorePages())
                                                                        <li class="page-item mt-1">
                                                                            <a class="page-link" href="{{ $asksType->nextPageUrl() }}" aria-label="Next">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/asksType/back'))}}" method="get">
...
@section('script')
    <script>
        (function () {
            ...
            $('.sidebarasksType').addClass('active');
            var target = $('.sidebarasksType').attr('href');
    ...
    <script>
        ...
        $(document).on('click', '#load_more_button', function() {
            var urlPath = `{{ route("admin/asksType/pagination/archives")}}/${offset}/${limit}`;
        ...
        $(document).on('keyup', '.data_search', function() {
            var q = $(this).val();
            var urlPath = "{{ route('admin/asksType/search/archives') }}";
            event.preventDefault();
