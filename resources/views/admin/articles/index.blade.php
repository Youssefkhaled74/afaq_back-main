                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Articles Viwes</h5>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <tbody id="tableShowData">
                                                        @isset($articles)
                                                            @foreach($articles as $record)
                                                                ...
                                                                @php
                                                                    if($record->article_type == 1){
                                                                        $type = 'Service';
                                                                    }elseif($record->article_type == 2){
                                                                        $type = 'Article';
                                                                    }elseif($record->article_type == 3){
                                                                        $type = 'Files';
                                                                    }elseif($record->article_type == 4){
                                                                        $type = 'Courses';
                                                                    }
                                                                @endphp
                                                                    ...
                                                                    <td class="text-center">
                                                                        <div class="dropdown d-inline-block">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end" style="text-align: end;">
                                                                                <li>
                                                                                    <a href="{{route('admin/articles/edit', $record->id)}}" class="dropdown-item edit-item-btn">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/articles/delete'))}}" method="get">
                                                ...
                                                <div class="modal fade" id="myModalActivation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                <form role="form" action="{{url(route('admin/articles/activate'))}}" method="get">
